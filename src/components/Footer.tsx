      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="md:col-span-5">
            <h2 className="font-serif text-3xl font-bold tracking-tight mb-6 text-brand-gold">
              Peculiar Treasure.
            </h2>
            <p className="text-gray-400 max-w-sm text-sm leading-relaxed mb-8">
              The premier lesson centre in Ibadan. We specialize in focused tutorials for Sciences, Arts, English, and Mathematics to prepare students for academic excellence.
            </p>
            
            {/* Social Media SVG Icons */}
            <div className="flex space-x-6 text-sm font-medium tracking-wide">
              <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors transform hover:scale-110" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors transform hover:scale-110" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors transform hover:scale-110" aria-label="X (Twitter)">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="md:col-span-3 md:col-start-7">
            ...
            <ul className="space-y-4 text-sm text-gray-300">
              ...
              <li><a href="#courses" className="hover:text-brand-gold transition-colors">Subjects</a></li>
              <li><a href="#features" className="hover:text-brand-gold transition-colors">The Experience</a></li>
              <li><a href="#contact" className="hover:text-brand-gold transition-colors">Register</a></li>
            </ul>
          </div>
