        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group perspective-1000 mt-12 lg:mt-0">
            ...
            <motion.img 
              ...
              className="hidden sm:block absolute -bottom-6 -left-6 md:-bottom-8 md:-left-8 xl:-bottom-12 xl:-left-12 aspect-square w-32 md:w-48 xl:w-64 object-cover border-4 md:border-8 border-[#faf9f6] shadow-2xl z-20 rounded-sm transition-transform duration-700 group-hover:-translate-y-4 group-hover:-translate-x-4" 
              style={{ y: y2 }}
            />
          </div>
